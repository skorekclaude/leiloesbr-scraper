...
OBJECTS = [
    ...
    # -- Podseria V/AK: Wspomnienia rękopiśmienne --
    {
        ...
        "opis_tresci": "Wspomnienia rękopiśmienne — nagłówek: 'Stosunek do Żydowstwa'. Krzysztof opisuje stosunki polsko-żydowskie z perspektywy osobistej: wspomina drobnych rzemieślników żydowskich, stosunki sąsiedzkie w przedwojennym Stryju/Krakowie, kontekst społeczny. Tekst analityczny, nie emocjonalny — próba obiektywnej refleksji nad współżyciem. Gęsty rękopis na dwóch stronach rozłożonego zeszytu.",
        "seria": "V",
        "tworca": "Krzysztof Andrzej Głuchowski",
        "jezyk": "polski",
