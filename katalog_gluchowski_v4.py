...
OBJECTS = [
    ...
    },
    {
        ...
        "opis_tresci": "Odpowiedź Ambasady Izraela na list K.A. Głuchowskiego z 18.V.1958 (zachowany w galerii p03_img02: 'Dear Sir, I am contemplating sale of my complete set of paper currency and coins in Lodz Ghetto during the German occupation of Poland. The above set is of great rarity and museum value and I wonder if some institution in Israel would not be interested in purchase.'). Ambasada sugeruje kontakt z Yad Vashem w Jerozolimie.",
        "seria": "VI",
    ...
    },
    {
        ...
        "opis_tresci": "Czterech mężczyzn na tle kamiennego budynku: (1) Z lewej: generał w polskim mundurze z orderami na piersi (prawdopodobnie Głuchowski). (2) Wysoki mężczyzna w ciemnym garniturze cywilnym — prawdopodobnie polski dygnitarz cywilny lub Prezydent RP na Uchodźstwie. (3) Oficer w mundurze brytyjskim. (4) Z prawej: mężczyzna w ceremonialnym stroju z łańcuchem urzędowym na szyi — Lord Provost (odpowiednik burmistrza w Szkocji) lub Lord Mayor. Zdjęcie dokumentuje kontakty polsko-brytyjskie na najwyższym szczeblu.",
        "seria": "II",
        "tworca": "fotograf prasowy / wojskowy",
        "jezyk": "n/a",
    ...
    },
    {
        ...
        "opis_tresci": "Trzech polskich oficerów przed wejściem do budynku z tablicą 'Prices of ADMISSION' (ceny biletów: Lounge or Balcony 1/9, One Block 1/6, Stalls 1/-, Pit 6d) — prawdopodobnie teatr lub kino w Dundee użyte na Zjazd Harcerzy. Na odwrocie adnotacja: 'Zjazd Harcerzy (T św) w Dundee / bez mjra Grażyńskiego (mała obsesja)' oraz 'ja, ppor. następca przew. Harcerstwo z Londynu'. Na dole: 'pierwszy od prawej ppłk. Kazimierz Szeszy'.",
        "seria": "II",
    ...
    },
    {
        ...
        "kontekst": "Orkiestra dudziarska prowadzona przez L. Sprusińskiego, z batalionu 4. Dywizji Piechoty, 1945 r. Polskie jednostki w Szkocji tworzyły własne orkiestry dudziarskie (pipe bands) — unikalny fenomen kulturowy: polscy żołnierze grający na szkockich instrumentach. 4. Dywizja Piechoty stacjonowała w Szkocji 1940-1947. Białe getry (spats) i berety Tam o'Shanter — elementy tradycji szkockiej przyjęte przez polskich muzyków wojskowych. Porównaj ze Świętem Łączności w Kinross (ARG/II/55) — podobny kontekst uroczystości wojskowych.",
    ...
    },
    {
        ...
        "opis_tresci": "Zestaw 5 fotografii: (1) Grupa oficerów na schodach budynku — adnotacja: 'Zjazd Kawalerzystów, 1941 kwiecień (początek), Szkocja'; (2) Oficerowie witają się — naszywki 'POLAND' na rękawach — adnotacja: 'powitanie gen. Broniewskiego w 1945 do Szkocji, na dworcu, przywitki... gen. Thorne'; (3) Dwóch oficerów wychodzących z budynku British Linen Bank — jeden w mundurze galowym z białymi rękawiczkami, drugi w battledress — gen. Głuchowski w Szkocji; (4) Portret gen. Głuchowskiego w płaszczu zimowym, stojącego w gotyckiej bramie, trzymającego czapkę — adnotacja: 'Gen. Głuchowski, Szkocja, 1941'; (5) Scena ceremonialna — oficerowie i cywile w kościele lub sali uroczystej. Na odwrotach: 'GEN. JANUSZ GŁUCHOWSKI / SZKOCJA', 'Trzymani w posiągaj poweri(?), 1941 r.'",
        "seria": "II",
    ...
    },
    {
        ...
        "opis_tresci": "Zestaw 4 fotografii: (1) Uroczystość/zabawa w obozie pod namiotem z dekoracjami — scena po wyzwoleniu; (2) Oficerowie na scenie podczas ceremonii obozowej; (3) Autobus wojskowy M 489 4153 — kobiety i żołnierze z oznaczeniami KGF (Kriegsgefangener = jeniec wojenny) podczas wsiadania/wysiadania, w tle motocykl z sidecar'em; (4) Oficer w berecie salutujący szpaler żołnierzy w hełmach na brukowanej ulicy szkockiego miasteczka. Na odwrocie adnotacja: 'Holandia — 1945 / Sceny z obozu naszych po uwolnieniu'.",
        "seria": "II",
    ...
    },
    {
        ...
        "opis_tresci": "'ŻOŁNIERZ Z MONTECASSINO: Album fotografii z terenu i okresu bitwy' — Wiktor Ostrowski (red.), Oddział Kultury i Prasy 2. Korpusu AP, Rzym 1945. Okładka: tytuł złotymi literami na tle fotografii polnych maków (maki z Monte Cassino = symbol polskiego zwycięstwa). Oprawa lniana, format podłużny. DEDYKACJA ODRĘCZNA na stronie tytułowej: 'Gł. J. Głuchowskiemu z wyrazami przyjaźni / w hołdzie [naszym?] bratnich doświadczeń do [Polski?] / W. Anders / 31.3.45'. Album dokumentujący bitwę o Monte Cassino (11-18.V.1944) — zwycięski szturm 2. Korpusu Polskiego na klasztor benedyktyński.",
        "seria": "II",
