...
<div class="academic-section" id="academic-articles">
  ...
  <div class="article-proposal">
    ...
    <div class="ap-novelty"><strong>Nowość naukowa:</strong> Powiązanie dokumentów prywatnych ze zbiorami Instytutu Piłsudskiego w Londynie (Zespół 70 — akta gen. Głuchowskiego). Pierwszy pełny katalog muzealny archiwum rodzinnego w standardzie ISAD(G).</div>
    <div class="ap-sources">Źródła: ARG/I/1–6, ARG/II/1–68, ARG/III/1–38, ARG/V/1–173, ARG/VI/1–29</div>
  </div>
  ...
  <div class="article-proposal">
    ...
    <div class="ap-novelty"><strong>Nowość:</strong> Korelacja relacji z Archiwum Historii Mówionej MPW z dokumentami z kolekcji. Pierwszy udokumentowany przypadek „fałszerstwa ochronnego" daty urodzenia w jednej rodzinie AK z pełnym łańcuchem dowodowym.</div>
    <div class="ap-sources">Źródła: ARG/V/1–4, ARG/V/158, ARG/V/161, ARG/III/34, ARG/V/13, ARG/V/69</div>
  </div>

  <div class="article-proposal">
    <h4>„DYSK — farmaceutka w oddziale dywersji kobiet. Wanda Głuchowska i Akcja Wilanów"</h4>
    <div class="ap-meta">
      <span class="ap-badge ap-type">studium przypadku</span>
    ...
    <div class="ap-novelty"><strong>Nowość:</strong> Rekonstrukcja losów rodziny, w której WSZYSCY dorośli członkowie walczyli w konspiracji. Matka-dywersantka, ojciec-kwatermistrz, syn-powstaniec — trzy różne formy oporu w jednym gospodarstwie domowym.</div>
    <div class="ap-sources">Źródła: ARG/III/28, ARG/V/158, ARG/V/161, portal 1944.pl</div>
  </div>

  <div class="article-proposal">
    <h4>„Od Siódemki Beliny do Instytutu Piłsudskiego — gen. Janusz Głuchowski i jego archiwum"</h4>
    <div class="ap-meta">
      <span class="ap-badge ap-type">artykuł archiwoznawczy</span>
