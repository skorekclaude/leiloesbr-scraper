...
#google_translate_element select {{ background:var(--surface); color:var(--text); border:1px solid var(--border); border-radius:3px; padding:4px 8px; font-size:0.82em; font-family:'Source Sans 3',sans-serif; cursor:pointer; }}
.goog-te-gadget {{ font-size:0; }}
.goog-te-gadget .goog-te-combo {{ background:var(--surface) !important; color:var(--text) !important; border:1px solid var(--border) !important; border-radius:3px; padding:6px 12px; font-size:13px !important; font-family:'Source Sans 3',sans-serif !important; }}
/* Hide Google Translate attribution bar */
.goog-te-banner-frame {{ display:none !important; }}
body {{ top:0 !important; }}
.skiptranslate {{ display:none !important; }}
.lang-bar .skiptranslate {{ display:inline-block !important; }}

/* data-lang: show only Polish originals, hide duplicates in other languages */
...
function googleTranslateElementInit() {{
  new google.translate.TranslateElement({{
    pageLanguage: 'pl',
    includedLanguages: 'pl,en,pt,de,nl,fr,yi,es,it,he,uk,ru,ja,zh-CN',
...
<div class="academic-section" id="academic-articles">
  <h2 data-lang="pl">Propozycje artykułów naukowych</h2>
  <h2 data-lang="en">Academic Article Proposals</h2>
...
/* Language is now handled by Google Translate — no manual switching needed */
...
/* No manual language init needed — Google Translate handles everything */
</script>
